...
parser.add_option("-o", "--output", action="store", type="string", dest="output", default="RD-Analyzer",
                  help="basename of output files [Default: RD-Analyzer]")

# Personalized parameters
parser.add_option("-p", "--personalized", action="store_true", dest="personalized", help="use personalized cut-offs")
parser.add_option("-m", "--min", action="store", type="int", dest="min",
                  help="read depth cut-off (in the unit of average depth, 0-1), used when '-p' is set")
parser.add_option("-c", "--coverage", action="store", type="float", dest="coverage",
                  help=" sequence coverage cut-off (0-1), used when '-p' is set")

# Debug mode
parser.add_option("-d", "--debug", action="store_true", dest="debug",
                  help="enable debug mode, keeping all intermediate files")
...
if os.path.isfile(outprefix + '.sam') or os.path.isfile(outprefix + '.bam') or os.path.isfile(
        outprefix + '.sort.bam') or os.path.isfile(outprefix + '.depth') or os.path.isfile(outprefix + '.result'):
...
class Main:
    ...
    def predLineage(self, inDict):
        ...
        if inDict['RD239_15'] == 'A':
            lineage.append("L1")
        if inDict['RD105_14'] == 'A' and inDict["RD142_17"] == 'P' and inDict["RD150_18"] == 'P' and inDict[
            "RD181_19"] == 'P' and inDict["RD207_20"] == 'P':
            lineage.append("L21")
        if inDict['RD105_14'] == 'A' and inDict["RD181_19"] == 'A' and inDict["RD207_20"] == 'A' and inDict[
            "RD142_17"] == 'P' and inDict["RD150_18"] == 'P':
            lineage.append("L221")
        if inDict['RD105_14'] == 'A' and inDict["RD181_19"] == 'A' and inDict["RD207_20"] == 'A' and inDict[
            "RD142_17"] == 'P' and inDict["RD150_18"] == 'A':
            lineage.append("L2211")
        if inDict['RD105_14'] == 'A' and inDict["RD181_19"] == 'A' and inDict["RD207_20"] == 'A' and inDict[
            "RD142_17"] == 'A' and inDict["RD150_18"] == 'P':
            lineage.append("L2212")
        if inDict['RD105_14'] == 'A' and inDict["RD142_17"] == 'P' and inDict["RD150_18"] == 'P' and inDict[
            "RD181_19"] == 'P' and inDict["RD207_20"] == 'A':
            lineage.append("L222")
        ...
        if inDict["7bp_pks15.1"] == '7D' and inDict["RD726_29"] == 'A':
            lineage.append("L462")
        if inDict["7bp_pks15.1"] == '7D' and inDict["RD183_25"] == 'P' and inDict["RD193_26"] == 'P' and inDict[
            "RD182_24"] == 'P' and inDict["RD761_30"] == 'P' and inDict["RD115_21"] == 'P' and inDict[
            "RD174_23"] == 'P' and inDict["RD122_22"] == 'P' and inDict["RD724_28"] == 'P' and inDict[
            "RD726_29"] == 'P' and inDict["RD219_27"] == 'P':
            lineage.append("L4o")
        ...
        if inDict['RD1mic_6'] == 'A':
            lineage.append("Mmic")
        if inDict['RD2seal_7'] == 'A' and inDict["7bp_pks15.1"] == '6D' and inDict['RD711_2'] == 'P' and inDict[
            'RD2bcg_8'] == 'P':
            lineage.append("Mpin")
        if inDict['RD12bovis_12'] == 'A' and inDict["7bp_pks15.1"] == '6D' and inDict['RD2bcg_8'] == 'P' and inDict[
            'RD1bcg_5'] == 'P' and inDict['RD4_4'] == 'P':
            lineage.append("Mcap")
...
if __name__ == "__main__":
    ...
    # BWA alignment
    if narg == 1:
        os.system("bwa mem -R '@RG\\tID:RD\\tSM:RD\\tLB:RD\\tPL:Illumina' %s %s > %s" % (
            dir + "/Reference/RDs30.fasta", input1, outprefix + ".sam"))

    if narg == 2:
        os.system("bwa mem -R '@RG\\tID:RD\\tSM:RD\\tLB:RD\\tPL:Illumina' %s %s %s > %s" % (
            dir + "/Reference/RDs30.fasta", input1, input2, outprefix + ".sam"))
    ...
    RDs = ["RD9_1", "RD711_2", "RD702_3", "RD4_4", "RD1bcg_5", "RD1mic_6", "RD2seal_7", "RD2bcg_8", "RD7_9", "RD8_10",
           "RD10_11", "RD12bovis_12", "RD12can_13", "RD105_14", "RD239_15", "RD750_16", "RD142_17", "RD150_18",
           "RD181_19", "RD207_20", "RD115_21", "RD122_22", "RD174_23", "RD182_24", "RD183_25", "RD193_26", "RD219_27",
           "RD724_28", "RD726_29", "RD761_30"]
    ...
    for RD in RDs:
        ...
        if percentage > coverage:
            prediction = 'P'
        resultMat.append(
            [RD, outStats[0], outStats[1], outStats[2], outStats[3], RD_length[RD], "%.2f" % percentage, prediction])
    ...
    outH.write(
        "# RD_name\tMaximum_depth\tMinimum_depth\tMedian_depth\t#pos_pass_cutoff\t#total_pos\t%pos_pass_cutoff\tPrediction\n")
